...
const appName = "Cemap 1";
const packageName = "cemap1.free.mock.text.exam.paper.speciment";
...
const databaseUrl = "https://1.cemap.icu";

const baseUrl = '$databaseUrl/Api/';

const accessValue = "8525";
...
const facebookGroupURL = 'https://www.facebook.com/groups/902497204370749';
