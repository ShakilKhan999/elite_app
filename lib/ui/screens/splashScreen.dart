...
class _SplashScreenState extends State<SplashScreen>
  ...
  void navigateToNextScreen() async {// original
      ...
      body: Stack(
        children: [
          BlocConsumer<SystemConfigCubit, SystemConfigState>(
            ...
            listener: (context, state) async {
              if (state is SystemConfigFetchSuccess) {
                print("---if state 001--SystemConfigFetchSuccess-- in blogConsumer--");
            ...
            builder: (context, state) {
              ...
              if (state is SystemConfigFetchFailure) {
                 print("---if state 001--SystemConfigFetchSuccess----");
                child = Scaffold(
          ...
          BlocBuilder<SystemConfigCubit, SystemConfigState>(
            ...
            builder: (context, state) {
              if (state is SystemConfigFetchFailure) {
                 print("---if state 001--SystemConfigFetchFailure----");
