                        ...
                        onPressed: () {
                          Navigator.of(context).pushNamed(
                            ...
                            arguments: {
                              ...
                              "userName": _userName,
                              "userProfileUrl": _userProfileImg,
                            },
                          );
                        },
                        icon: SvgPicture.asset(
                          UiUtils.getImagePath("chat.svg"),
                          color: Colors.white,
                          width: MediaQuery.of(context).size.width * 0.08,
                                ...
                                Container(
                                  ...
                                  child: const Column(
                                    children: [
                                      ...
                                      Text(
                                        'Very convenien app for CeMap Quizzes\n practice. Very simple & useful app.',
